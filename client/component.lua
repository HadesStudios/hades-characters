...
function RetrieveComponents()
	...
	Characters = exports['hades-base']:FetchComponent('Characters')
	Action = exports['hades-base']:FetchComponent('Action')
	Ped = exports['hades-base']:FetchComponent('Ped')
end
...
RegisterNetEvent('Characters:Client:SetData', function(key, data, cb)
	if key ~= -1 then
        ...
        LocalPlayer.state.Character = exports['hades-base']:FetchComponent('DataStore'):CreateStore(1, 'Character', data)
	end
    
    exports['hades-base']:FetchComponent('Player').LocalPlayer:SetData('Character', LocalPlayer.state.Character)
...
CHARACTERS = {
	...
	Logout = function(self)
		Callbacks:ServerCallback('Characters:Logout', {}, function()
			...
			Action:Hide()
			exports['hades-base']:FetchComponent('Spawn'):InitCamera()
			SendNUIMessage({
				type = 'APP_RESET',
			})
			Wait(500)
			exports['hades-base']:FetchComponent('Spawn'):Init()
		end)
	end,
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
	exports['hades-base']:RegisterComponent('Characters', CHARACTERS)
end)
